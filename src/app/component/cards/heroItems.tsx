...
const HeroItem: React.FC<HeroItemProps> = ({ title, subtitle, image, link }) => {
  return (
    <div className="relative  flex-1 overflow-hidden h-full">
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 text-center text-secondary bg-gradient-to-t from-gray-800 to-transparent w-full py-10 lg:py-10 px-4 md:px-6">
